      ...
      <section className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-xl backdrop-blur md:p-8">
        ...
        <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
            ...
            <p className="mt-1 text-2xl font-semibold text-emerald-800">{done}</p>
          </div>
        </div>
        ...
        {todos.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-6 py-10 text-center">
            <p className="text-base font-medium text-slate-700">Chưa có công việc nào</p>
            <p className="mt-2 text-sm text-slate-500">Hãy thêm todo đầu tiên của bạn.</p>
          </div>
        ) : (
