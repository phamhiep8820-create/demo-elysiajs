...
export type Context<in out Route extends RouteSchema = {}, in out Singleton extends SingletonBase = {
    ...
    headers: undefined extends Route['headers'] ? {} extends NonNullable<Singleton['resolve']['headers']> ? Record<string, string | undefined> : Singleton['resolve']['headers'] : PrettifyIfObject<Route['headers'] & Singleton['resolve']['headers']>;
