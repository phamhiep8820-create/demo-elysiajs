...
import type { AnySchema, ElysiaConfig, InputSchema, IsAny, MaybeArray, StandaloneInputSchema, UnwrapSchema } from './types';
...
export interface ElysiaTypeCheck<T extends AnySchema> extends Omit<TypeCheck<TSchema>, 'schema' | 'Check'> {
    ...
    schema: T;
    config: object;
    Check(value: unknown): T extends TSchema ? boolean : {
